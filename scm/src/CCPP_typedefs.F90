...
!+ PUMAS
    if (Model%imp_physics == Model%imp_physics_pumas) then
       allocate (Interstitial%micro_accre_enhan(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numice_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numliq_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_pmid(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_pint(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_pdel(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_airT(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_refl10cm(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_arefl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_refl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_acsrfl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_csrfl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_reflz10cm(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_areflz(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_ncai(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_ncal(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_airq(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_cldliq(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_cldice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numliq(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%init_micro_rainliq(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%init_micro_snowice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numrain(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numsnow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%init_micro_graupice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numgraup(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_relvar(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_strat_cldfrc(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_strat_liq_cldfrc(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_strat_ice_cldfrc(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_qsatfac(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_naai(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_npccn(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_rndst(ixs:ixe,Model%micro_nlev, Model%micro_dust_nbins))
       allocate (Interstitial%micro_nacon(ixs:ixe,Model%micro_nlev, Model%micro_dust_nbins))
       allocate (Interstitial%micro_snowice_tend_external(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numsnow_tend_external(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_effi_external(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_frzimm(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_frzcnt(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_frzdep(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_qcsinksum_rate1ord(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_airT_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_airq_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_cldliq_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_cldice_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numliq_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numice_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_rainliq_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_snowice_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numrain_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numsnow_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_graupice_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numgraup_tend(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_effc(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_effc_fn(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_effi(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_sadice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_sadsnow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_prect(ixs:ixe))
       allocate (Interstitial%micro_preci(ixs:ixe))
       allocate (Interstitial%micro_prec_evap(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_am_evap_st(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_prec_prod(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_cmeice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_deffi(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_pgamrad(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_lamcrad(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_snowice_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_scaled_diam_snow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_graupice_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numgraup_vol_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_scaled_diam_graup(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_lflx(ixs:ixe,Model%micro_nlevp1))
       allocate (Interstitial%micro_iflx(ixs:ixe,Model%micro_nlevp1))
       allocate (Interstitial%micro_gflx(ixs:ixe,Model%micro_nlevp1))
       allocate (Interstitial%micro_rflx(ixs:ixe,Model%micro_nlevp1))
       allocate (Interstitial%micro_sflx(ixs:ixe,Model%micro_nlevp1))
       allocate (Interstitial%micro_rainliq_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_reff_rain(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_reff_snow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_reff_grau(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numrain_vol_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numsnow_vol_in_prec(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_frefl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_fcsrfl(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_rercld(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_rainliq(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_snowice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numrain_vol(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numsnow_vol(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_diam_rain(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_diam_snow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_graupice(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_numgraup_vol(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_diam_graup(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_freq_graup(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_freq_snow(ixs:ixe,Model%micro_nlev))
       allocate (Interstitial%micro_freq_rain(ixs:ixe,Model%micro_nlev))
